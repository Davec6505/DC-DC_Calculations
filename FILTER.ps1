...
Write-Result "" "None"
Write-Result "#################################################################" "Cyan"
Write-Result "######################Filter Summary############################" "Cyan"
...
Write-Result ("    - ZOut (magnitude only): {0} Ohm`t[= (j*2pi*f*Lf) / (1 - (Lf*Cf1*(2pi*f)^2) + j*(2pi*f*Rd*Cf1))]" -f $ZOut_Mag) "Magenta"
Write-Result ("    - ZOut (phase): {0} deg`t[= atan2(ZOut.Imaginary, ZOut.Real) * 180 / pi]" -f $ZOut_Phase) "Magenta"
Write-Result ("    - ZOut (rect): ( {0} + {1}j ) Ohm`t[= (j*2pi*f*Lf) / (1 - (Lf*Cf1*(2pi*f)^2) + j*(2pi*f*Rd*Cf1))]" -f $ZOut.Real, $ZOut.Imaginary) "Magenta"
Write-Result "##################################################################" "Cyan"
